...
This page contains the sensor fusion dataset from the paper Heterogeneous Multi-Sensor Tracking for an Autonomous Surface Vehicle in a Littoral Environment. Get the datasets [here](https://github.com/Autoferry/sensor_fusion_dataset) or by following the *View on GitHub* link above.
