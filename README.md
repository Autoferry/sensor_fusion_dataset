...
This github repo contains the sensor fusion dataset from the paper Heterogeneous Multi-Sensor Tracking for an Autonomous Surface Vehicle in a Littoral Environment.
